NAME=draft-spaghetti-sidrops-rpki-new-ccr-states
...
# $(NAME).txt $(NAME).html $(NAME).exp.xml: $(NAME).xml CCR-2026.asn example.ccr.ascii
$(NAME).txt $(NAME).html $(NAME).exp.xml: $(NAME).xml CCR-2026.asn
